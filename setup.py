...
scripts=glob.glob('scripts/*.py') + glob.glob('scripts/analysisDB/*.py') +glob.glob('scripts/RNA_analysis/*.py') + glob.glob('scripts/bcbb_helpers/*.py') + glob.glob('scilifelab/lims_utils/*.py') + ['scripts/pm', 'scripts/stdin_to_redis']
try:
    scripts.remove("scilifelab/lims_utils/__init__.py");
except ValueError:
    pass
