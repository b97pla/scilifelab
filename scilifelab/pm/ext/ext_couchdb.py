...
def add_shared_couchdb_options(app):
    ...
    group.add_argument('--dbname', help="Database name", default=None, type=str)
    group.add_argument('--user', help="Database user. Default '{}'".format(user), nargs="?", default=user, type=str)
