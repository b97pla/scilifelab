...
class DeliveryReportController(AbstractBaseController):
    ...
    def _setup(self, app):
        ...
        group.add_argument('--bc_count', help="Manually set barcode counts. Input is either a string or a JSON file with a key:value mapping, as in '--bc_count \"{'Sample1':100, 'Sample2':200}\"'.", action="store", default={})
