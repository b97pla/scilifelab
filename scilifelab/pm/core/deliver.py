...
class DeliveryReportController(AbstractBaseController):
    ...
    def _setup(self, app):
        ...
        group.add_argument('--phix', help="Provide phix error rate for new illumina flowcells where phix error rate is missing. Input is either a string or a JSON file with a lane:error mapping, for example '--phix \"{1:0.3, 2:0.4}\".", action="store", default=None)
